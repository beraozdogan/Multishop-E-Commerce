...
namespace MultiShop.WebUI.Services.MessageServices
{
    public class MessageService : IMessageService
    {
        ...
        {
            var responseMessage = await _httpClient.GetAsync("http://localhost:6000/services/Message/UserMessage/GetMessageInbox?id=" + id);
        ...
        {
            var responseMessage = await _httpClient.GetAsync("http://localhost:6000/services/Message/UserMessage/GetMessageSendbox?id=" + id);
